 ...
 * @param timeOff - duration of receiver OFF phase, expressed in multiples of 128/125 \B5s (~1 \B5s). Max value is 255.
 *
 * output parameters
 *
 * no return value
 ...
 *
 * input parameters:
 * @param snooze_time - "short sleep" phase duration, expressed in multiples of 512/19.2 \B5s (~26.7 \B5s). The counter
 *                      automatically adds 1 to the value set. The smallest working value that should be set is 1,
 *                      i.e. giving a snooze time of 2 units (or ~53 \B5s).
 *
 * output parameters
 *
 * no return value
