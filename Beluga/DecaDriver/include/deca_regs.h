...
#define RX_EQUAL_FP_AMPL2_MASK                                                 \
    0xFFFF0000ULL /* First Path Amplitude point 2 - magnitude of 2nd point     \
                     after Ceiling(FP_Index) */
...
#define RX_EQUAL_FP_AMPL3_MASK                                                 \
    0x0000FFFF00000000ULL /* First Path Amplitude point 3 - magnitude of 1st   \
                             point after Ceiling(FP_Index)  */
...
#define RX_TIME_FP_AMPL1_OFFSET                                                \
    (7) /* byte 7..8 16 bit First Path Amplitude - magnitude of 3rd point      \
           after Ceiling(FP_Index) */
 ...
 * timeout) since this risks IC malfunction due to prolonged receiver activity
 * in the event of false preamble detection.
 */
...
#define RF_CONF_PGMIXBIASEN_MASK                                               \
    0x0000A700UL /* Enable TX mixer bias and pulse gen */
...
#define TC_PGCCTRL_TMEAS_MASK                                                  \
    0x3C /* Mask to retrieve number of clock cycles over which to run PG cal   \
            counter */
#define TC_PGCCTRL_ON_TX 0x40 /* Perform autocal on each TX enable */
#define TC_PGCCTRL_DIR_CONV                                                    \
    0x80 /* Direction (converging) of autocal binary search */

#define TC_PGCAL_STATUS_OFFSET                                                 \
    0x09 /* Status register from PG calibration block */
#define TC_PGCAL_STATUS_LEN (1)
#define TC_PGCAL_STATUS_DELAY_MASK                                             \
    0xFFF /* Mask to retrieve PG delay count from calibration */
...
#define AON_CFG1_LPOSC_CAL                                                     \
    0x0004 /* This bit enables the calibration function that measures the      \
              period of the ICs internal low powered oscillator */
...
#define OTP_SF_OPS_SEL_TIGHT                                                   \
    0x20 /* Operating parameter set selection: Tight                           \
          */
